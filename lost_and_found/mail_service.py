...
def send_point_purchase_mail(name):
    try:
        ...
        email_from = settings.EMAIL_HOST_USER
        recipient_list = ['braculostandfound@gmail.com']
        send_mail(subject, message, email_from, recipient_list)
        return True
    except Exception as e:
        print(e)
...
def send_claim_acception_mail(user, email):
    try:
        ...
        Please Contact with the publisher for further details. Thank you for using our service.-(Brac University Lost and Found). Please give us feedback on our service.
